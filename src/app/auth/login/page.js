        ...
        <div class=" bg-surface-100 py-8 px-4 shadow sm:rounded-xl sm:px-10">
          ...
          <form className="mt-5 " onSubmit={LogInpUser}>
            <div className="space-y-2">
              <label
                for="email"
                class="block text-sm font-medium leading-5  text-dark-700"
              >
                Email
              </label>
            ...
            <div className="space-y-2 mt-6">
              ...
              <div class="mt-1 relative rounded-lg ">
                ...
                />
                <div
                  class="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer text-[#b0b0c0] hover:text-[#686870]"
            ...
            <div class="mt-6">
              <span class="block w-full rounded-lg shadow-sm">
                <button
                  type="submit"
                  class="w-full flex justify-center py-3 px-4 text-sm font-medium rounded-lg text-dark-100 bg-[#03A1D8] hover:bg-[#2799bf] focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-indigo-700 transition duration-150 ease-in-out"
                >
                  Sign in
                </button>
              </span>
          ...
          <div className="text-[#8A8A95] text-sm text-center mt-3 space-y-3">
            ...
            <p>or</p>
              <button class="w-full flex justify-center py-3 px-4 hover:text-surface-100 border bg-transparent text-sm font-medium rounded-lg text-[#03A1D8]  border-[#03A1D8] hover:bg-blue-300 focus:outline-none focus:shadow-outline-indigo active:bg-indigo-700 transition duration-150 ease-in-out">
