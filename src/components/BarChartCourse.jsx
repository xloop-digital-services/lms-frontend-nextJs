                    ...
                    const dataMapping = [
                      {
                        label: "Classes",
                        details: [
                          `Percentage: ${barData.classes_percentage.toFixed(2)}`,
                      ...
                      },
                      {
                        label: "Attendance",
                        details: [
                          `Percentage: ${barData.attendance_percentage.toFixed(2)}`,
                      ...
                      },
                      {
                        label: "Assignments",
                        details: [
                          `Percentage: ${barData.percentage_assignments.toFixed(2)}`,
                      ...
                      },
                      {
                        label: "Quizzes",
                        details: [
                          `Percentage: ${barData.percentage_quizzes.toFixed(2)}`,
                      ...
                      },
                      {
                        label: "Projects",
                        details: [
                          `Percentage: ${barData.percentage_projects.toFixed(2)}`,
