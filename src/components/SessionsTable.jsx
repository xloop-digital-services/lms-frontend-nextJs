                        ...
                        .map((session, index) => {
                          return (
                            <tr key={index} className={``}>
                             <td
                                className="px-6 py-4 whitespace-nowrap max-w-[230px] truncate text-sm text-gray-800 "
                                title={session.batch}
                              >
                                {session.batch}
                              </td>
                              <td
                                className="px-6 py-4 whitespace-nowrap text-sm max-w-[250px] truncate text-gray-800"
                            ...
                            >
                              ...
                              <td
                                className={`whitespace-nowrap py-4 px-6 text-sm text-gray-800  relative`}
                              >
                                {session.start_date || "-"}
                              </td>
                              <td
