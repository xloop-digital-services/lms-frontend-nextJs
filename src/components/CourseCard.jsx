...
const CourseCard = ({
  ...
  return (
    <div className="w-[330px] lg:mx-0 mx-auto group bg-transparent ">
      <div className="rounded-xl h-92 p-2 border border-blue-100 group-hover:cursor-pointer group-hover:border-2 group-hover:border-blue-300">
        <Image
          src={image}
          alt="here you go"
        ...
        <div className="space-y-3 text-sm px-4 pt-[6px]">
          ...
          <div className="flex justify-between items-center">
            ...
            <Link href={`/courses/course/${id}`} className="text-[#fcfeff] bg-[#03A1D8] p-1 rounded-full">
