                        ...
                        <table className="min-w-full divide-y divide-dark-200 dark:divide-gray-700">
                            <thead className="bg-dark-50 dark:bg-dark-700">
                                <tr >
                                    ...
                                    <th scope="col" className="px-6 py-4 text-start text-sm  text-gray-500 uppercase w-[16%]">Verify</th>
                            ...
                            <tbody className="divide-y divide-dark-200 dark:divide-gray-700">
                                <tr>
                                    ...
                                    <td className="px-6 py-3 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">25</td>
                                    <td className="px-6 py-3 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">Karachi</td>
                                    <td className="px-6 py-3 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">Dastagir</td>

                                    <td className="px-6 py-3 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">16 years</td>
                                    ...
                                    <td>
                                      <p className='bg-[#D84848] text-[#fff] rounded-lg px-8 py-2 w-[100px]'>False</p>
                                    </td>
